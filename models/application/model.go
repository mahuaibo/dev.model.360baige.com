...
type Application struct {
	...
	Status           int    `db:"status" json:"status"`                         // 状态 0停用  1启用  2退订
...
type ApplicationTpl struct {
	...
	Type             int    `db:"type" json:"type"`                           // 类型 1天气  2体育  3旅游  4工具  5视频  6社交  7参考  8效率  9摄影  10新闻  11音乐  12医学  13生活  14健康健美  15游戏  16财经  17娱乐  18教育  19商务  20图形设计  21软件开发
	Desc             string    `db:"desc" json:"desc"`                        // 简介
	Status           int    `db:"status" json:"status"`                       // 状态 0下架
	Price            int64    `db:"price" json:"price"`                       // 价格
	PayType          int    `db:"pay_type" json:"payType"`                    // 0:限免 1:永久免费 2:1次性收费 3:周期收费
	PayCycle         int    `db:"pay_cycle" json:"payCycle"`                  // 0无1月2季3半年4年
