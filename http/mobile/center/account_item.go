...
type AccountItemStatisticsCond struct {
	...
	Income    int64 `json:"monthIncome"` // 收入
	Pay       int64 `json:"monthPay"`    // 支出
}
...
type AccountItemList struct {
	...
	InAccount   int64 `json:"inAccount"`             // 进账
	OutAccount  int64 `json:"outAccount"`            // 出账
}
...
type AccountItemListValue struct {
	...
	Balance    int64 `json:"balance"`     // 交易金额类型
}
